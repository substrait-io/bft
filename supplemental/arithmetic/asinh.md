...
The precision of the asinh function depends on the architecture in various dialects.

### Output Range

The asinh function has an output range of all Real numbers, and it results to 0
at 0.
