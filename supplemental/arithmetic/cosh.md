...
Hyperbolic cosine of an input can yield a result that is not exactly
...
The precision of the cosh function depends on the architecture in various dialects.

### Output Range

The hyperbolic cosine functions has an output range of [1, Infinity], where it results to 1
at 0 radians.
